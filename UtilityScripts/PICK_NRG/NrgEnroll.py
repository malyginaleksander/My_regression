...
from Regression.generators.zip_city_generator  import generator_zip_city
...
class NrgEnroll(BasePage):
        ...
        state_loc = 'id_service_address_state'
        ...
        def enter_state(self, state):
            self.sendKeys(state, self.state_loc)
...
#                  pass
        ...
        def fill_personalinformation(self, payload):
            global first_name_generated, last_name_generated, email_generated, address, city_
            ...
            time.sleep(1)
            try:
                self.driver.find_element_by_xpath("//a[text()='Use as it is']").click()
            except:
                pass
            self.driver.find_element_by_id(self.zipcode_loc).click()
            ...
            self.driver.find_element_by_id(self.zipcode_loc).send_keys(str(zipcode_))
            ...
            self.enter_agreementdetails(account_number)
            try:
                self.enter_member_firstname(firstname)
                self.enter_member_lastname(lastname)
            ...
            try:
                self.driver.find_element_by_id('id_electric-billing_uan').send_keys(account_number)
            except:pass
