...
worksheet = workbook.sheet_by_name('IB-NRG_regression')
...
## Grab Conformation Code
    ...
    confcode = elem.text
    print("Passed - NRG_regression Inbound Electric Production, Confirmation =  " + confcode + ' for ' + state + ' - ' + given_utiity)
