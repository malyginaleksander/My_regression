...
def test_state(driver, payload):
    print(payload.tc, 'NRG_regression Inbound Production Multi Electric Enrollment - State = ', payload.state, ' - utility = ', payload.utility)
    ...
    # Electric Account
    energyPlusFill.nrg_multi_electric_acct_steps(payload)

    ## Offer:
    energyPlusFill.nrg_multi_elec_offer()
