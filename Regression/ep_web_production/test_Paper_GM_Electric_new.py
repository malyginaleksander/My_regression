...
def test_state(driver, payload):
    ...
    energyPlusFill.select_acct_type("Residential")
    energyPlusFill.fill_business_info(payload)
    energyPlusFill.fill_billing_info_GM_electric(payload)
    energyPlusFill.fill_GM_electric_info(payload)
    energyPlusFill.fill_order_info_GM_electric(payload)
