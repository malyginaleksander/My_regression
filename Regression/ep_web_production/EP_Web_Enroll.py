...
for current_row in range(1,worksheet.nrows):
    ...
    pfname = worksheet.row(current_row)[21].value
    plname = worksheet.row(current_row)[22].value
...
# Personal Information
    ...
    elem = driver.find_element_by_id("Service_City").send_keys("trenton")
...
## Gas        
    try:
        ...
        try:
            elem = driver.find_element_by_id("AccountMainGas")
            if  elem.is_displayed():
                elem = elem.find_element_by_class_name("usage_units").send_keys("123")
        except:
            pass
...
#Grab Conformation Code
    ...
    confcode = elem.text
    print("Passed - EP Web Production Enrollment, Confirmation =  " +confcode + ' for - ' +LocalUtility)
