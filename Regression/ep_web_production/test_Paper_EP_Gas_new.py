...
def test_state(driver, payload):
    print(payload.tc, 'Production Paper App, Brand = EP, Type = Gas - ', 'state =', payload.state, '- utility =', payload.utility)
    ...
    energyPlusFill.fill_billing_info_EP_Gas(payload)
    energyPlusFill.fill_gas_info(payload)
    energyPlusFill.fill_order_info_EP_Gas(payload)
