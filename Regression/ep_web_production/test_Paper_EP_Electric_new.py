...
def _state_test_internals(driver,payload):
    ...
    energyPlusFill.select_acct_type(payload.account_type)
    energyPlusFill.fill_business_info(payload)
    energyPlusFill.fill_billing_info_EP_electric(payload)
    energyPlusFill.fill_EP_electric_info(payload)
    energyPlusFill.fill_order_info_EP_electric(payload)
