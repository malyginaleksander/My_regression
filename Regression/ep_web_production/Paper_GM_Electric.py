...
for current_row in range(1,worksheet.nrows):
    ...
    rate_class = worksheet.row(current_row)[16].value
    zone = worksheet.row(current_row)[17].value
    product = worksheet.row(current_row)[18].value
...
# Grab Conformation Code
    ...
    confCode = elem.text
    print("Passed - GM Paper - Electric Production, " + confCode +' for ' + state +' - ' + given_utiity)
