...
def test_awards(driver, payload):
    ...
    elem = driver.find_element_by_id("gs_DemandAdder").send_keys("0.066")
    ...
    elem = driver.find_element_by_id("DemandAdder").send_keys("99")
    ...
    elem = driver.find_element_by_id("gs_DemandAdder").send_keys(Keys.ENTER);
    driver.implicitly_wait(10)
    element = driver.find_element_by_xpath("/html/body/div[1]/div[3]/div/div[5]/div[3]/div[3]/div[3]/div/table/tbody/tr[2]/td[2]")
