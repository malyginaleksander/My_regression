...
def test_awards(driver, payload):
    ...
    elem = driver.find_element_by_id('Holiday').send_keys("06/14/2017")
    elem = driver.find_element_by_id('Holiday').send_keys(Keys.ENTER);
    elem = driver.find_element_by_id("HolidayDescription").click()
    elem = driver.find_element_by_id('HolidayDescription').send_keys("Flag Day666")
    time.sleep(2)
