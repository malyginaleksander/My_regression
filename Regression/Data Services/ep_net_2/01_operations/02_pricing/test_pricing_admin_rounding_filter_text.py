...
rounding = [
    ['tc-01', 'filter Admin Rounding Price Limits by MAx Limit', 'gs_RoundingPriceLimitMax', '/html/body/div[1]/div[3]/div/div[5]/div[3]/div[3]/div[3]/div/table/tbody/tr[2]/td[3]', '5.5', '5.50'],
]
