...
def test_awards(driver, payload):
    ...
    for option in elem.find_elements_by_tag_name('option'):
        if option.text == ("01"):
            option.click()      
    time.sleep (1)
    elem = driver.find_element_by_id('UtilityPrice').send_keys("88")
    #elem = driver.find_element_by_id('UtilityPrice').send_keys(Keys.ENTER);
    #elem = driver.find_element_by_id("UtilityPrice").click()
    time.sleep(2)
