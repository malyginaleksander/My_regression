...
segment = [
    ['tc-01', 'filter Price Segment by Unti', 'gs_Unit', '/html/body/div[1]/div[3]/div/div[4]/div/div[3]/div[3]/div/table/tbody/tr[2]/td[2]', 'P'],
    ['tc-02', 'filter Price Segment Log by Rounding Method', 'gs_RoundingMethod', '/html/body/div[1]/div[3]/div/div[4]/div/div[3]/div[3]/div/table/tbody/tr[2]/td[5]', 'Round9'],
    ['tc-03', 'filter Price Segment Log by Demand Status', 'gs_SegmentStatus', '/html/body/div[1]/div[3]/div/div[4]/div/div[3]/div[3]/div/table/tbody/tr[2]/td[6]', 'ACTIVE'],
]
