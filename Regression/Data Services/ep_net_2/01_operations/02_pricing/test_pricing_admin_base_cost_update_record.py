...
def test_awards(driver, payload):
    ...
    elem = driver.find_element_by_id("gs_Ancillary").send_keys("0.9991")
    elem = driver.find_element_by_id("gs_Ancillary").send_keys(Keys.ENTER);
    ...
    elem = driver.find_element_by_id("BaseSupply").send_keys(Keys.CONTROL, "a");
    elem = driver.find_element_by_id("BaseSupply").send_keys(Keys.DELETE);
    elem = driver.find_element_by_id("BaseSupply").send_keys("0.66666")
