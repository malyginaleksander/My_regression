...
award = [
    ['tc-01', 'search award by Account ID', 'AccountID', '/html/body/div[1]/div[3]/div/div[1]/div[3]/div[3]/div[3]/div/table/tbody/tr[2]/td[4]', '136'],
    ['tc-02', 'search award by Utility Account ID', 'Acct', '/html/body/div[1]/div[3]/div/div[1]/div[3]/div[3]/div[3]/div/table/tbody/tr[2]/td[3]', '0084915159'],
    ['tc-03', 'search awards by Ben ID', 'Id', '/html/body/div[1]/div[3]/div/div[1]/div[3]/div[3]/div[3]/div/table/tbody/tr[2]/td[1]', '6037']
]
