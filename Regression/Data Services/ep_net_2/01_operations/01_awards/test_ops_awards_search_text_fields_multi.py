...
award = [
    ['tc-01', 'search award by Account ID and Utility Account Number', 'AccountID', 'Acct', '/html/body/div[1]/div[3]/div/div[1]/div[3]/div[3]/div[3]/div/table/tbody/tr[2]/td[4]', '136', '0084915159'],
    ['tc-02', 'search award by Utility Account ID and Ben Id', 'AccountID', 'Id', '/html/body/div[1]/div[3]/div/div[1]/div[3]/div[3]/div[3]/div/table/tbody/tr[2]/td[4]', '136', '6037'],
    ['tc-03', 'search awards by Utility Account Number and Ben Id', 'Acct', 'Id', '/html/body/div[1]/div[3]/div/div[1]/div[3]/div[3]/div[3]/div/table/tbody/tr[2]/td[3]', '0084915159', '6037']
]
