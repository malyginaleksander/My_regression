...
Payload = namedtuple('payload', ['tc', 'tc_description', 'acct'])

member = [
    ['tc-01', 'promo change', '5687099006'],
]
...
def test_member(driver, payload):
    ...
    #https://energyplus.atlassian.net/browse/PROD-2568

    driver.get("http://epnet2.pt.nrgpl.us/member")
    driver.implicitly_wait(10)

    elem = driver.find_element_by_id("memberFormSearchCriteria").send_keys(payload.acct)
    driver.implicitly_wait(10)
    elem = driver.find_element_by_xpath("/html/body/div/div[3]/div/div/div[4]/div[3]/div[3]/div/table/tbody/tr[2]/td[2]").click()
    time.sleep(10)
    elem = driver.find_element_by_xpath("/html/body/div[1]/div[3]/div/div[2]/div/div[2]/div[1]/div/ul/li[4]/a").click()
    driver.implicitly_wait(10)
    elem = driver.find_element_by_id("btnNewPromo").click()
    time.sleep(10)
    elem = driver.find_element_by_xpath("/html/body/div[7]/div[2]/div/div[5]/ul/li[1]").click()
    elem = driver.find_element_by_id("btnAddNewBundle").click()
    time.sleep(3)