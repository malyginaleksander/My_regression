...
def test_promo(driver, payload):
    ...
    elem = driver.find_element_by_id("ctl00_MainContent_btnAddNewComponent").click()
    elem = driver.find_element_by_id("ctl00_MainContent_gvPromotionAwards_ctl02_txtDescription").send_keys("adding component")
    elem = driver.find_element_by_id("ctl00_MainContent_gvPromotionAwards_ctl02_txtBonusTriggerDays").send_keys("24")
    elem = driver.find_element_by_name("ctl00$MainContent$gvPromotionAwards$ctl02$ctl00").click()
    time.sleep(5)
    assert "adding component" in driver.page_source
    elem = driver.close