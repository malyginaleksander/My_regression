...
def test_campaign(driver, payload):
    print(payload.tc, ' - ', 'Add Update Partner')
    ...
    time.sleep(5)
    elem = driver.find_element_by_id("ctl00_MainContent_gvCampaignPartners_ctl02_EditButton").click()
    elem = driver.find_element_by_id("ctl00_MainContent_gvCampaignPartners_ctl02_txtDateStart").send_keys("7/1/2019")
    time.sleep(5)
    elem = driver.find_element_by_id("ctl00_MainContent_gvCampaignPartners_ctl02_txtDateEnd").send_keys("7/22/2020")
