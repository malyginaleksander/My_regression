...
def test_promo(driver, payload):
    ...
    time.sleep(5)
    elem = driver.find_element_by_id("ctl00_MainContent_gvPromotions_ctl02_EditButton").click()
    time.sleep(5)
    elem = driver.find_element_by_name("cctl00_MainContent_gvPromotions_ctl02_txtPromoName").send_keys(Keys.CONTROL, 'a');
    time.sleep(3)
    elem = driver.find_element_by_name("ctl00_MainContent_gvPromotions_ctl02_txtPromoName").send_keys(Keys.BACKSPACE);
    elem = driver.find_element_by_name("ctl00_MainContent_gvPromotions_ctl02_txtPromoName").send_keys("update record")
