...
def test_campaign(driver, payload):
    ...
    driver.implicitly_wait(10)
    time.sleep(5)
    elem = driver.find_element_by_id("ctl00_MainContent_gvCampaigns_ctl53_hlCampaignDetails").click()
    driver.implicitly_wait(10)
    time.sleep(5)
    assert "Return to Campaign List" in driver.page_source
    elem = driver.close