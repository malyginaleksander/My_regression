...
def test_partner(driver, payload):
    ...
    elem = driver.find_element_by_id("ctl00_MainContent_ddlPromotions")
    for option in elem.find_elements_by_tag_name('option'):
        if option.text == ("(002) $50 Check After 2 Months"):
            option.click()	
    elem = driver.find_element_by_id("ctl00_MainContent_btnAddPromoToPartner").click()

    assert "The promotion has been added for this partner." in driver.page_source