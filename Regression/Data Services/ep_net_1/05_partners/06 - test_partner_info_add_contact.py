...
def test_partner(driver, payload):
    ...
    elem = driver.find_element_by_name("ctl00$MainContent$gvPartnerContacts$ctl02$ctl00").send_keys("aal_contact")
    elem = driver.find_element_by_id("ctl00_MainContent_gvPartnerContacts_ctl02_UpdateButton").click()
    time.sleep(5)

    assert "aal_contact" in driver.page_source