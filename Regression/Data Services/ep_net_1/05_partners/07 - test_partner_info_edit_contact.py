...
def test_partner(driver, payload):
    ...
    elem = driver.find_element_by_id("ctl00_MainContent_gvPartnerContacts_ctl03_EditButton").click()
    elem = driver.find_element_by_name("ctl00$MainContent$gvPartnerContacts$ctl03$ctl01").send_keys("contact_last_name")
    elem = driver.find_element_by_id("ctl00_MainContent_gvPartnerContacts_ctl03_UpdateButton").click()
    time.sleep(5)

    assert "contact_last_name" in driver.page_source