...
def test_channel(driver, payload):
    ...
    elem = driver.find_element_by_id("next_partnerDetailPager").click()
    assert "View 101 - 200" in driver.page_source
    print ("next");
    
    elem = driver.find_element_by_id("prev_partnerDetailPager").click()
    ...
    elem = driver.find_element_by_id("first_partnerDetailPager").click()
    assert "View 1 - 100" in driver.page_source
    print ("first");
