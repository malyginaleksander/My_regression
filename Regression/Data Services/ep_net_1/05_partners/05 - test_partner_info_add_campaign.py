...
def test_partner(driver, payload):
    ...
    elem = driver.find_element_by_id("ctl00_MainContent_ddlCampaigns")
    for option in elem.find_elements_by_tag_name('option'):
        if option.text == ("American online (0015)"):
            option.click()	
    elem = driver.find_element_by_id("ctl00_MainContent_btnAddCampaignToPartner").click()

    assert "The campaign was added successfully." in driver.page_source