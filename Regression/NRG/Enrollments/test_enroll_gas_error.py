...
worksheet = workbook.sheet_by_name('gas error')
...
def test_state(driver, payload):
    print(payload.tc, 'NRG_regression WEB Gas UAN Error Check - State = ', payload.state, ' - utility = ', payload.utility)
    ...
    NrgEn.verify_error_message(payload)

    ##Note: Cannot remove time.sleep for this script.