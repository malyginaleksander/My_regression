...
worksheet = workbook.sheet_by_name('Friendlyname')
...
for current_row in range(1, worksheet.nrows):
    ...
    friendlyname.append(Payload(**value_dict))
...
@pytest.mark.parametrize("payload", friendlyname, ids=[p.tc for p in friendlyname])
def test_login(driver, payload):
     print( )
     try:
        _test_friendlyname( driver, payload )
...
def _test_friendlyname(driver, payload):
        ...
        login.edit_friendlyname(payload)
