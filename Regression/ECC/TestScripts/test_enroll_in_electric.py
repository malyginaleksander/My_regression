...
from Regression.PageFactory.ConfirmPlanPage import ConfirmPlanPage
from Regression.States.NrgEnroll import NrgEnroll
from Regression.ECC_PageFactory.test_SignUpAccount import test_SignUpAccount
...
from Regression.PageFactory.ThanksPage import ThanksPage
from Regression.ECC_PageFactory.LoginPage import LoginPage
import pytest
from Regression.PageFactory.test_cognito import test_user


local_path = "C:\\Users\\AMALYGIN\\Downloads\\Regression-master (5)\\Regression-master\\Regression\\ECC_TestData\\TestData.xlsx"
full_path = os.path.abspath(local_path)
workbook = xlrd.open_workbook(full_path)
worksheet = workbook.sheet_by_name('Electric_Enroll')
...
def _state_test_internals(driver, payload):
         host = os.environ.get('ECC_ENROLL_HOST', 'http://nrg.enroll.qa.nrgpl.us/')
         ...
         time.sleep(3)
         tsignup.click_portallink_signup(driver, "08516492688", "Welcome@123", payload)
