...
for current_row in range(1, worksheet.nrows):
    ...
    email_TOSlink.append(Payload(**value_dict))
...
@pytest.mark.parametrize("payload", email_TOSlink, ids=[p.tc for p in email_TOSlink])
...
def test_state(driver, payload):
     ...
     try:
        ...
        import uuid
        filename = "./failed/test_email_TOSlink_fail_{}_{}.png".format(payload.tc,uuid.uuid4())
