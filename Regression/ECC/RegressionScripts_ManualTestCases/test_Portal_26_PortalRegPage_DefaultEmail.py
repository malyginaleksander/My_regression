...
DefaultEmail_RegisterPortalPage = []
...
for current_row in range(1, worksheet.nrows):
    ...
    DefaultEmail_RegisterPortalPage.append(Payload(**value_dict))
...
@pytest.mark.parametrize("payload", DefaultEmail_RegisterPortalPage, ids=[p.tc for p in DefaultEmail_RegisterPortalPage])
...
def test_state(driver, payload):
     ...
     try:
        ...
        import uuid
        filename = "./failed/test_DefaultEmail_RegisterPortalPage{}_{}.png".format(payload.tc,uuid.uuid4())
...
def _state_test_internals(driver, payload):
        ...
        tsignup.click_portal_link(driver, "0590486798183508200000", "Welcome@123", payload)
