...
for current_row in range(1, worksheet.nrows):
    ...
    confirmationpage_preferences.append(Payload(**value_dict))
...
@pytest.mark.parametrize("payload", confirmationpage_preferences, ids=[p.tc for p in confirmationpage_preferences])
