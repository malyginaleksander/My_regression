...
def test_ChangePassword(driver, payload):
     print( )
     try:
        _test_changepassword( driver, payload )
     except Exception as ae:
        import uuid
        filename = "./failed/test_changepwd_{}_{}.png".format(payload.tc,uuid.uuid4())
...
def _test_changepassword(driver, payload):
        ...
        time.sleep(4)
        actText =  driver.find_element_by_xpath("//div//*[@id='changepasswordconfirmation']/div").text
        expText = "Password successfully changed."
        assert expText in actText

        driver.find_element_by_xpath("//div//*[@id='changepasswordconfirmation']/div/button[text()='Close']").click()
