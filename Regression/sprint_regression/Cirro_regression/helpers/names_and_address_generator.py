...
def names_and_address_generator():
    ...
    return address_house_street_generated, first_name_generated, last_name_generated, email_generated, phone_area_code_generated, phone_last_generated, phone_prefix_generated, email_generated, phone_number_generated, address_house_street_generated, member_number
