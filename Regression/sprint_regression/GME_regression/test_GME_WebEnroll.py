...
from Regression.sprint_regression.GME_regression.GME_WebEnroll_settings import *
...
def test_state(driver, payload):
    ...
    try:
        ...
        filename = "./outbox_data_files/failed/test_email_portallink_fail__{}_{}."+ current_time+ "png".format(payload.tc,uuid.uuid4())
