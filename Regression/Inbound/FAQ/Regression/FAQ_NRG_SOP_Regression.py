...
elem = driver.find_element_by_id("Rate Class RA - Residential Service Add On Heat Pump").click()
...
worksheet = workbook.sheet_by_name('NRG_regression-SOP')
...
for current_row in range(1,worksheet.nrows):
    ...
    if header in driver.page_source:
        print ("Passed NRG_regression SOP - ",header)
    else:
        print ("Failed NRG_regression SOP - ",header)
