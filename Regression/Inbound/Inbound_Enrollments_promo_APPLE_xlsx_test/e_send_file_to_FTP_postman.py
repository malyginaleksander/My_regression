...
# from Regression.ECC.TestScripts.test_TLP_Enrollments_electric.test_settings import sql_env, formated_to_txt_folder
...
def check_files_in_ftp():
    ...
    input_files_counter = len(input_folder)
    input_files_list = []
    for name in input_folder:
...
def test_send_to_ftp():
    ...
    print("\n 5.Connecting to pysftp nerfsftp.dev.nrgpl.us server...\n")
    cnopts = pysftp.CnOpts()
    cnopts.hostkeys = None
