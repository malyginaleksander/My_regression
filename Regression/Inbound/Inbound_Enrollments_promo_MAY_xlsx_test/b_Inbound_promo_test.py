...
from Regression.Inbound.Inbound_Enrollments_promo_MAY_xlsx_test.InboundPromo_tests_Settings import *
...
def grab_code(payload,  promo_text,  first_name, last_name, ServiceAddress1, account_number, offer_1,offer_2, offer_3, offer_4, offer_5, offer_6 ):
    global confcode
    ...
    if os.path.isfile(csv_filename):
        ...
        csv_a.writerow(
            [payload.ts, 	payload.PremiseType, 	payload.sku, 	payload.BrandSlug, 	payload.ChannelSlug,
             payload.ProductName, 	payload.TermsOfServiceTyp, 	 	str("'" + str(account_number)),
             first_name, 	last_name, 	payload.UtilitySlug, 	 payload.PartnerCode, payload.PromoCode,   payload.promo_compaign_code, payload.Commodity,
             ServiceAddress1, 	payload.ServiceAddress2, 	payload.city, 	payload.StateSlug, 	payload.zip_code,
             payload.email, 	payload.emailmarketing, date_, confcode, promo_text, text_checking,  offer_1, offer_2, offer_3, offer_4, offer_5, offer_6 ])
        ...
        csv_a.writerow(
            ['ts', 	'PremiseType', 	'sku', 	'BrandSlug', 	'ChannelSlug',
             'ProductName', 	'TermsOfServiceTyp', 	 	'account_no',
             'first_name', 	'last_name', 	'UtilitySlug',  'PartnerCode', 'PromoCode',   'promo_compaign_code', 'Commodity',
             'ServiceAddress1', 	'ServiceAddress2', 	'city', 	'StateSlug', 	'zip_code',
             'email', 	'emailmarketing', "test_date", "conf_code",  'promo_text', 'text_checking', 'offer_1', 'offer_2', 'offer_3', 'offer_4', 'offer_5', 'offer_6'])
        csv_a.writerow(
            [payload.ts, 	payload.PremiseType, 	payload.sku, 	payload.BrandSlug, 	payload.ChannelSlug,
             payload.ProductName, 	payload.TermsOfServiceTyp, 	 	str("'" + str(account_number)),
             first_name, 	last_name, 	payload.UtilitySlug, 	 payload.PartnerCode, payload.PromoCode,   payload.promo_compaign_code, payload.Commodity,
...
def Inbound_start_test(test_setup, payload):
    ...
    # q =  str(payload.PromoCode[1:])
    # if payload.PromoCode[1] =='0':
    #     promo_code = str(payload.PromoCode[1:])
    # else:
    ...
    grab_code(payload, promo_text,  first_name, last_name, ServiceAddress1, account_number, offer_1, offer_2, offer_3, offer_4, offer_5, offer_6 )
