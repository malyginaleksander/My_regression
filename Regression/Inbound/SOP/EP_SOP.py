...
for current_row in range(1,worksheet.nrows):
    ...
    zipcode = worksheet.row(current_row)[5].value
    area_code = worksheet.row(current_row)[6].value
    prefix = worksheet.row(current_row)[7].value
    last = worksheet.row(current_row)[8].value
    accountNo = worksheet.row(current_row)[9].value
...
## Grab Conformation Code
    ...
    confcode = elem.text
    print("Passed - EP Inbound SOP, Conformation =  " +confcode)
