...
worksheet = workbook.sheet_by_name('NRG_regression Multi Account')
...
## Offer:
    ...
    driver.find_element_by_xpath('/html/body/div[2]/div/div[1]/div[1]/div/div[4]/div[2]/div/div[4]/p[2]/span/input').send_keys('Essentials Electric Variable Plan')
    time.sleep(1)
    driver.find_element_by_xpath('/html/body/div[2]/div/div[1]/div[1]/div/div[4]/div[2]/div/div[4]/div[1]/div/div[3]/ul/li[3]/span[2]').click()
    # driver.find_element_by_xpath('//*[@id="Essentials Electric"]').click()
...
## Customer Info:
    ...
    # elem = driver.find_element_by_xpath("/html/body/div[2]/div/div[1]/div[2]/div[2]/div[6]/input").send_keys(int(accountNo))
...
## Grab Conformation Code
    ...
    f.write( confcode +" " + "NRG_regression Multi Account" + "\n")
## Submit:	
