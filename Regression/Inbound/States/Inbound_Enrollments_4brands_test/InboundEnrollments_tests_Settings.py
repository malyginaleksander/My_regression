...
tester = "Alex"
workbook_name = "././Regression_test_scenarios.xlsx"
# data_sheet_name = 'Inbound_Test_Data'
# data_sheet_name = 'NRG_regression'
data_sheet_name = 'Inbound_Test_Data _regression19'
start_string ="8"       #number of TS  in Data file to start tests
env = "pt"
# env = "GME_en"
...
# chosen_driver = "chrome"  #choose "firefox" or "chrome"
# URL = "http://www.gme-plus.energypluscompany.com/myinbound/login.php"
# start_page = 'http://www.gme-plus.energypluscompany.com/myinbound/tab_brand.php'
# login_email_data = "gurjeet.saini@nrg.com"
# login_password_data = "energy"
# workbook_name = "./inbox_files/test_scenarios_INBOUND_file.xlsx"
# # workbook_name = "./inbox_files/test_scenarios_INBOUND_file.xlsx"
# data_sheet_name = 'Migration'
# start_string ="215"       #number of TS  in Data file to start tests