...
def account_generator_accountNo_1(payload):
    if payload.utility_1 == 'Atlantic City Electric' or payload.utility_1 =='Delmarva Power' or payload.utility_1 == 'Delmarva Power' or payload.utility_1 =='Pepco'  or payload.utility_1== 'Atlantic City Electric':
    ...
    elif payload.utility_1 == 'PSE&G Gas' and payload.account_type_1 == 'Gas' or payload.account_type_1 == 'New Jersey Natural Gas' or payload.account_type_1 == 'PSEG Gas':
        ...
        if payload.utility_1 == "Peoples Gas" or payload.utility_1 == "PNGPA" :
            ac_temp = randint(10000000000, 99999999899)  # 11 digits starts with 2
            ac_str = str(ac_temp)
            accountNo_1_ = str('2' + ac_str)
        elif payload.utility_1 == "Philadelphia Gas Works" or payload.utility_1=='PPL Electric Utilities' or payload.utility_1=='PGW':
