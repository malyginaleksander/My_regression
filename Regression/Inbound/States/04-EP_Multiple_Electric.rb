...
partner=worksheet.cells(rows,"E").value
campaign=worksheet.cells(rows,"F").value
promo=worksheet.cells(rows,"G").value
address=worksheet.cells(rows,"H").value
city=worksheet.cells(rows,"I").value
zip=worksheet.cells(rows,"J").value
area_code=worksheet.cells(rows,"K").value
prefix=worksheet.cells(rows,"L").value.to_s
last=worksheet.cells(rows,"M").value.to_s
account_number=worksheet.cells(rows,"N").value.to_s
account_number2=worksheet.cells(rows,"O").value.to_s
...
browser.select_list(:xpath => '/html/body/div[2]/div/div[1]/div[7]/div[3]/select').select utility
...
#Offer
if
browser.button(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[1]/div/p/button[2]').exists?
browser.button(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[1]/div/p/button[2]').click
end

sleep 8
browser.button(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[1]/div/p/button[2]').click #variable
browser.select_list(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[1]/div/div[2]/div[1]/p[1]/select').select "Cash Back"
browser.select_list(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[1]/div/div[2]/div[1]/p[2]/select').select "Brand Residential - PA - BRC"
...
if
browser.button(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[2]/div/p/button[2]').exists?
browser.button(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[2]/div/p/button[2]').click
end

sleep 2
browser.button(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[2]/div/p/button[2]').click
browser.select_list(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[2]/div/div[2]/div[1]/p[1]/select').select "Cash Back"
browser.select_list(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[2]/div/div[2]/div[1]/p[2]/select').select "Brand Residential - PA - BRC"
browser.select_list(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[2]/div/div[2]/div[2]/p[1]/select').select "0000 - Unknown"
browser.select_list(:xpath => '/html/body/div[2]/div/div[1]/div[3]/div[2]/div/div[2]/div[2]/p[2]/select').select "015 - $25 bonus / 3%"
...
browser.radio(:xpath => '/html/body/div[2]/div/div[1]/div[2]/div[2]/div[5]/input[1]').set
browser.text_field(:xpath => '/html/body/div[2]/div/div[1]/div[2]/div[2]/div[6]/input').set account_number2
browser.button(:xpath => '/html/body/div[2]/div/div[1]/div[2]/div[2]/div[6]/button').click
browser.button(:value => 'Save and Continue').click
...
CSV.open('C:\\Scripts\\Inbound\\States\\EP_Multiple_Account_Conf_data.csv', 'ab') do |csv|
