...
browser.button(:xpath => '/html/body/div[2]/div/div[1]/div[7]/div[6]/button[1]').click
sleep 2
...
browser.text_field(:xpath => '/html/body/div[2]/div/div[1]/div[2]/div[2]/div[5]/input').set account_number
...
CSV.open('C:\\Scripts\\Inbound\\States\\GreenMT_Multiple_State_Conf_data.csv', 'ab') do |csv|
csv << [browser.span(:id => 'confcode').text, plan=worksheet.cells(rows,"I").value,sku=worksheet.cells(rows,"AE").value, 
price=worksheet.cells(rows,"AC").value]
end
end
