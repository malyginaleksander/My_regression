...
browser.radio(:xpath => '/html/body/div[2]/div/div[1]/div[7]/div[2]/div[1]/label/input').set
sleep 2
...
browser.text_field(:xpath => '/html/body/div[2]/div/div[1]/div[2]/div[2]/div[6]/input').set account_number
...
CSV.open('C:\\Scripts\\Inbound\\States\\NRG_Multiple_Electric_Conf_data.csv', 'ab') do |csv|
