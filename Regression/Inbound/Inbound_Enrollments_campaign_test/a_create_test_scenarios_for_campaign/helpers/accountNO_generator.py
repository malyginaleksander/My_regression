...
def account_generator_accountNo(Utility):
    ...
    if Utility == 'Atlantic City Electric'  or Utility.upper()== 'ace'.upper() \
        ...
        or Utility.upper()  == "duq".upper()\
            or Utility.upper()  == "DEOHG".upper()\
            or Utility.upper()  == "Dominion (DEOHG)".upper() : # DEOHG - Account Number must be either a 5 or 13 digit number, duq - should be 10 or 13 digits long.
    ...
    elif Utility.upper()  == "Philadelphia Gas Works".upper()   \
            or Utility.upper() =='PGW'.upper()\
            or Utility.upper() =='PPL Electric Utilities'.upper() \
            or Utility.upper() =='PPL'.upper()\
