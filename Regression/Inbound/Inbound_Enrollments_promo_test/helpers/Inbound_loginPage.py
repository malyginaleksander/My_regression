...
# from Regression.Inbound.States.Inbound_Enrollments_promo_AMTRAK_test import InboundPromo_tests_Settings
from Regression.Inbound.Inbound_Enrollments_promo_test import InboundPromo_tests_Settings
...
class LoginPage():
    ...
    def fill_login(self, login_email = InboundPromo_tests_Settings.login_email_data, login_password = InboundPromo_tests_Settings.login_password_data):
        # global elem
