...
from Regression.helpers.common.names_and_address_generator import names_and_address_generator
from Regression.helpers.common.utility_dict import find_zip_city_
...
def servicereference_generator(payload):
    if payload.UtilitySlug == 'Philadelphia Gas Works':
        servicereference = random.randint(1000000000, 9999999999)  # 10 digits
    else:
        servicereference_rand = random.randint(100000000, 999999999)
