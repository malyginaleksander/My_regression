...
workbook = xlrd.open_workbook("./OH_Data.xlsx")
...
for current_row in range(1,worksheet.nrows):
    ...
    accountNo = worksheet.row(current_row)[16].value
    busnamedet = worksheet.row(current_row)[17].value
    pfname = worksheet.row(current_row)[18].value
    plname = worksheet.row(current_row)[19].value
