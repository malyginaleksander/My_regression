...
local_path = "./EP_Web/Enrollments/OH/OH_Data.xlsx"
full_path = os.path.abspath(local_path)
workbook = xlrd.open_workbook(full_path)
worksheet = workbook.sheet_by_name('OH')
...
def test_state(driver, payload):
    print(payload.tc, 'EP Web Ohio Enrollment -','utility =', payload.LocalUtility, '- account_type =', payload.account_type, '- greenopt =', payload.greenopt_check)    
    ...
    # personal info fill
    EPEnroll.fillEnrollDetails(payload,"apt 2a", "cleveland")
