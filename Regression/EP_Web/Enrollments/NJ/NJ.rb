...
workbook=excel.Workbooks.Open("C:\\Scripts\\EP_Web\\Enrollments\\NJ\\NJ_Data.xlsx") #Edit this to point to your location.
...
member_number=worksheet.cells(rows,"U").value.to_s
...
browser.text_field(:id => 'partner_memnum').set member_number
...
CSV.open('C:\\Scripts\\EP_Web\\Enrollments\\NJ\\NJ_Conf_data.csv', 'ab') do |csv|
