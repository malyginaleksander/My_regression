...
local_path = "./EP_Web/Enrollments/NJ/NJ_Data.xlsx"
...
def test_state(driver, payload):
    print(payload.tc, 'EP Web New Jersey Enrollment -','utility =', payload.LocalUtility, '- account type =', payload.account_type, '- greenopt =', payload.greenopt_check)    
    ...
    # personal info fill
    EPEnroll.fillEnrollDetails(payload,"apt 2a", "trenton")
