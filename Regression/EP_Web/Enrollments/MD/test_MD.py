...
local_path = "./EP_Web/Enrollments/MD/MD_Data.xlsx"
full_path = os.path.abspath(local_path)
workbook = xlrd.open_workbook(full_path)
worksheet = workbook.sheet_by_name('MD')
...
def test_state(driver, payload):
    print(payload.tc, 'EP Web Maryland Enrollment -','utility =', payload.LocalUtility, '- account_type =', payload.account_type, '- greenopt =', payload.greenopt_check)
    ...
    # personal info fill
    EPEnroll.fillEnrollDetails(payload,"apt 2a", "baltimore")
    ...
    EPEnroll.fill_gas_details_for_MD_NJ(payload, "123", "July", "No, I'm non-exempt")
