...
workbook=excel.Workbooks.Open("C:\\Scripts\\EP_Web\\Enrollments\\MA\\MA_Data.xlsx") #Edit this to point to your location.
...
CSV.open('C:\\Scripts\\EP_Web\\Enrollments\\MA\\MA_Conf_data.csv', 'ab') do |csv|
